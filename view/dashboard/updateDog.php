...
$hide = "";
    ...
    if(isset($_POST['submitBtn'])){
        ...
        $image = $_FILES["image"]["name"]; 
            ...
            $dogRepository->updateDog($id, $name, $breed, $color, $age, $gender, $size, $coatLength, $image);
        ...
        <div class="form-box">
            ...
            <h1>Update</h1>
                <div class="input-group">
                    ...
                    <div class="input-field left">
                    <input type="text" name="coatLength"  value="<?=$dog['coatLength']?>" placeholder="Coat length" id="coatLength">
                ...
                <div class="input-field right">
                    ...
                    <div class="input-field right">
                        <input type="text" name="gender"  value="<?=$dog['gender']?>" placeholder="Gender" id="gender">
